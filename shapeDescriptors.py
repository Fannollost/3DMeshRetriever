...
weight = { propertyDescriptorTypes.A3.value: 1, propertyDescriptorTypes.D1.value : 1, propertyDescriptorTypes.D2.value : 1, propertyDescriptorTypes.D3.value : 1,
                     propertyDescriptorTypes.D4.value : 1, globalShapeDescriptorTypes.SURFACE_AREA.value : 27, globalShapeDescriptorTypes.VOLUME.value : 1,
                     globalShapeDescriptorTypes.COMPACTNESS.value : 1, globalShapeDescriptorTypes.RECTANGULARITY.value : 16, globalShapeDescriptorTypes.CONVEXITY.value:43,
