...
weight = { globalShapeDescriptorTypes.SURFACE_AREA.value : 1, globalShapeDescriptorTypes.VOLUME.value: 1,
                     ...
                     globalShapeDescriptorTypes.CONVEXITY.value: 1, globalShapeDescriptorTypes.ECCENTRICITY.value : 1,
                     globalShapeDescriptorTypes.DIAMETER.value : 1, propertyDescriptorTypes.A3.value : 1, 
                     propertyDescriptorTypes.D1.value : 1, propertyDescriptorTypes.D2.value : 1, 
                     propertyDescriptorTypes.D3.value : 1 , propertyDescriptorTypes.D4.value: 1
        }